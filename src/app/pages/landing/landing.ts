...
export class Landing {
  ...
  readonly membros = signal<Membro[]>([
    ...
    },
    {
      ...
      email: 'vinicius.sebold@example.com',
      ...
      contribuicoes: [
        'Aplicação web full-stack para gestão de estoque, vendas e lucros, com painel de análise em tempo real.',
        'Responsável pelo front-end em Angular, incluindo design, prototipagem, desenvolvimento e integração com o backend.',
        ...
        'Realizei o deploy na nuvem utilizando Railway e configurei o domínio web da aplicação.',
        'Coordenei a implementação de novas funcionalidades, garantindo a entrega de soluções completas, funcionais e seguindo boas práticas de desenvolvimento.',
      ],
    },
    {
      nome: 'Sidney Arthur',
